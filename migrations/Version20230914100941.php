 ...
 */
final class Version20230914100941 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blocs_page ADD bloc_color VARCHAR(255) DEFAULT NULL, CHANGE bloc_h3 bloc_h3 VARCHAR(255) DEFAULT NULL, CHANGE bloc_image bloc_image VARCHAR(255) DEFAULT NULL, CHANGE bloc_lien_text bloc_lien_text VARCHAR(255) DEFAULT NULL, CHANGE bloc_lien_url bloc_lien_url VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blocs_page DROP bloc_color, CHANGE bloc_h3 bloc_h3 VARCHAR(255) DEFAULT \'NULL\', CHANGE bloc_image bloc_image VARCHAR(255) DEFAULT \'NULL\', CHANGE bloc_lien_text bloc_lien_text VARCHAR(255) DEFAULT \'NULL\', CHANGE bloc_lien_url bloc_lien_url VARCHAR(255) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE contact CHANGE society society VARCHAR(255) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE messenger_messages CHANGE delivered_at delivered_at DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\'');

 ...
 */
final class Version20241030134739 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles_blog CHANGE contenu2 contenu2 LONGTEXT NOT NULL, CHANGE meta_description meta_description LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles_blog CHANGE contenu2 contenu2 LONGTEXT DEFAULT NULL, CHANGE meta_description meta_description LONGTEXT DEFAULT NULL');

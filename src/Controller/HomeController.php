...
class HomeController extends AbstractController
{
    ...
    #[Route("/{chemin}", name: "dynamic_page", requirements: ["chemin" => "^(?!admin$|login$|logout$|contact$|croissance$|conseil-et-strategie$|referencement-naturel-seo$|seo$|marketing-de-loffre$|communication-de-crise$|consulting-et-developpement$|campagnes-digitales$|mentions-legales$|gestion-des-cookies$|data-analyse$|community-management-et-rp$|creation-editoriale-et-storytelling$|agence$|ecoindex$|tech-et-digital$).+"], methods: ["GET"])]
